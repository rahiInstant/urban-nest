  ...
  return (
    <div className=" flex items-center justify-center  select-none mt-24">
      ...
      <div className="w-full sm:w-fit mx-4 border-slate-400 border  rounded-2xl flex flex-col  items-end relative">
        ...
        <div className="w-full h-[55%] sm:h-[70%] lg:h-[65%] absolute top-0 rounded-xl card-header   z-0 flex justify-center ">
        ...
        <div className=" p-5 rounded-2xl h-[55%] w-full sm:w-[500px] lg:w-[800px] z-20 bg-white">
